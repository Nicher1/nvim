...
vim.keymap.set('n', '<leader>lg', ':LazyGit<cr>', { desc = 'Use [L]azy[G]it' })
...
local servers = {
  ...
  pyright = {
    python = 'C:\\ProgramData\\chocolatey\\bin\\python3.13.exe'
  },
...
-- vimtex configurations for SumatraPDF on Windows
...
vim.keymap.set('n', '<leader>lv', '<cmd>VimtexView<CR>', { desc = 'View PDF with SumatraPDF' })
